    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px] md:max-w-fit max-w-full">
        ...
        <p className="truncate">
          Example:
          /ip4/192.3.44.231/tcp/4001/p2p/12D3KooWMayZxfV47NQ5dtJ8UTczc8oYPzD5WAhtVM6fy5qhfHcZ
        </p>
        <Input
          id="name"
          value={addr}
          onChange={(e) => setAddr(e.target.value)}
          className="ring-1 ring-zinc-600"
        />
        <DialogFooter>
          <Button disabled={!addr} onClick={addConnection}>
            Add
          </Button>
        </DialogFooter>
      </DialogContent>
